...
class MagenThemes_MTBejewelry_Helper_Cssgen extends Mage_Core_Helper_Abstract
{
	/**
	...
	public function __construct()
	{
		...
		$this->_generatedCssPath = 'frontend/mtbejewelry/default/' . $this->_generatedCssFolder;
