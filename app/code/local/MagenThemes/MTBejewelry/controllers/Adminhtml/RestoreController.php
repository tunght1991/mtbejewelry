...
?>
<?php
class MagenThemes_MTBejewelry_Adminhtml_RestoreController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _isAllowed()
    {
        return Mage::getSingleton('admin/session')
            ->isAllowed('magenthemes/mtbejewelry/restore');
    }

    protected function _initAction()
    {
        $this->loadLayout()
            ->_setActiveMenu('magenthemes/mtbejewelry/restore')
    ...
    public function indexAction()
    {
        ...
        $this->_title($this->__('MagenThemes'))
            ->_title($this->__('mtbejewelry'))
            ->_title($this->__('Restore Defaults'));
        $this->_addContent($this->getLayout()->createBlock('mtbejewelry/adminhtml_restore_edit'));
        $this->renderLayout();
    }
    ...
    public function restoreAction()
    {
	    ...
	    try {
            ...
            $this->_restoreSettings($defaults->getNode('default/mtbejewelry_design')->children(), 'mtbejewelry_design');
            Mage::getSingleton('adminhtml/session')->addSuccess(
                Mage::helper('adminhtml')->__('Default Settings for mtbejewelry Design Theme has been restored.'));
        }
        catch (Exception $e) {
