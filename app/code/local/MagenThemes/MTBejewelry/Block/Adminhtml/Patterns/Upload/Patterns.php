...
?>
<?php
class MagenThemes_MTBejewelry_Block_Adminhtml_Patterns_Upload_Patterns extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element){ 
       	$html = parent::_getElementHtml($element);
		$directry = Mage::getBaseDir('media').DS.'wysiwyg'.DS.'magenthemes'.DS.'mtbejewelry'.DS.'patterns';
        ...
        $html .='<link href="'.$urlparth.'skin/adminhtml/mtbejewelry/css/style.css'.'" type="text/css" rel="stylesheet">';
		$html .='<div class="listpattern '.$element->getHtmlId().'_pattern">';
			...
			$html .='<span class="item">
						<img src="'.$urlparth.'media/wysiwyg/magenthemes/mtbejewelry/patterns/'.$img.'" />
